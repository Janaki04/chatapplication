...
export default function ContactInfoDrawer({ isOpen, onClose, activeUser }) {
  ...
  return (
    <aside className="w-80 bg-white border-l border-gray-100 flex flex-col flex-shrink-0 overflow-y-auto animate-in slide-in-from-right duration-200">
      
      {drawerSubView === 'info' && (
        <>
          <div className="flex items-center px-4 py-5 border-b border-gray-50 space-x-3">
            <button onClick={handleCloseAll} className="text-gray-400 hover:text-gray-600 transition-colors">
          ...
          <div className="p-6 flex flex-col items-center text-center border-b border-gray-50">
            ...
            <div className="flex items-center space-x-8 mt-5">
              <button className="flex flex-col items-center space-y-1 text-gray-600 hover:text-indigo-600 group">
                <div className="p-2 text-gray-500 group-hover:text-indigo-500 transition-colors">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="p-6 border-b border-gray-50">
            ...
            <p className="text-sm font-bold text-gray-900">Hi there, I am using</p>
          </div>
          ...
          <div className="p-4 grid grid-cols-2 gap-3 mt-auto">
            <button className="py-2.5 border border-blue-200 text-blue-500 hover:bg-blue-50 rounded-xl font-bold text-xs transition-colors flex items-center justify-center space-x-2">
          ...
          <div className="flex border-b border-gray-100 text-sm font-medium text-center">
            {['media', 'links', 'docs'].map((tab) => (
              <button
                ...
                className={`flex-1 py-3.5 capitalize border-b-2 font-semibold ${
